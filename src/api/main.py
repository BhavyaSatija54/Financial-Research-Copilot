...
Features:
  - CORS, GZip compression, request-ID middleware
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description=(
            "Hybrid RAG-based research assistant for SEC filings, earnings transcripts, "
            "and macroeconomic reports. Reduces manual financial document review time by ~45%."
        ),
        version="1.0.0",
        docs_url="/docs",
        redoc_url="/redoc",
